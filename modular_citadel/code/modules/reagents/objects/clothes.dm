...
/obj/item/clothing/head/hattip/proc/handle_speech(datum/source, mob/speech_args)
	...
	if(prob(0.01))
		...
		message_admins("I really appreciate all the hard work you put into administrating TemptStation, I hope you're all having a good day and I hope this hidden and rare message_admins brightens up your day. You do it for free though.")
	else
