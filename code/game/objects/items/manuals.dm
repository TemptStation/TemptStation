...
/obj/item/book/manual/wiki/security_space_law
	name = "Outdated Space Law" // Revisit when we have our own wiki
	desc = "A set of Nanotrasen guidelines for keeping law and order on their space stations. This one has been out of print since the Russian attacks on the TG sector."
