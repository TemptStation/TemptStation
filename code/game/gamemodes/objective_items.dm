...
/datum/objective_item/steal/hoslaser
	...
	altitems = list(/obj/item/gun/ballistic/revolver/mws, /obj/item/gun/ballistic/automatic/pistol/enforcer/red, /obj/item/choice_beacon/hosgun) //We now look for either the alt verson of the hos gun or the beacon picker.
