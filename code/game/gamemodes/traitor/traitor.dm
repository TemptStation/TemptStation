...
/datum/game_mode/traitor
	...
	protected_jobs = list("Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Chief Engineer", "Chief Medical Officer", "Research Director", "Quartermaster", "Blueshield")	//citadel change - adds HoP, CE, CMO, and RD to ling role blacklist
	required_players = 0
	required_enemies = 1
