...
<<<<<<< HEAD
=======
	AddElement(/datum/element/flavor_text/carbon, _name = "Naked Flavor Text", _save_key = "naked_flavor_text", _show_on_naked = TRUE)
>>>>>>> parent of 62c0e523c8 ("modularity" fix)
