/datum/job/qm
	...
	custom_spawn_text = "<font color='red'>Work with other departments to fulfill orders. Sell off excess amounts of metals and various empty crates as necessary. Keep track of your miners by occasionally checking in with them via radio.<br>You are fifth in line to be Acting Captain.</font>"
