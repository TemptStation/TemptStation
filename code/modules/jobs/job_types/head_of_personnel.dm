/datum/job/hop
	...
	custom_spawn_text = "<font color='red'>Open and close job slots as necessary, ensure priority jobs are marked as needed, <b>do not leave your ID console signed in</b>, and work with the other departments to settle interpersonal disputes. ALWAYS ask other department heads before assigning crew to new jobs or granting access.<br>You are first in line to be Acting Captain.</font>"
