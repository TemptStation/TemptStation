/datum/job/blueshield
	...
	custom_spawn_text = "<font color='red' size='2'><b>You are not part of command.</b> You exist to protect members of Command. The Chain of Command takes priority, but that may change if lower level heads come to face greater risk.</font>"
...
/area/command/blueshield_quarters
